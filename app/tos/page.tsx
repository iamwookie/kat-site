export default function TOS() {
    return (
        <>
            ...
            <div className="p-1">
                <p>3.1 KAT does not collect any personal user information, other than search results.</p>
                <p>
                    3.2 Search results may include information such as the track title, track author, and/or url to the track, which may be considered personal
                    information in certain jurisdictions, however, this data is stored solely for the purpose of statistics.
                </p>
                <p>
                    3.3 KAT stores Discord User IDs to associate users with their search results, any other sort of information is not stored. This information
                    is solely used to help the bot function and operate.
                </p>
            </div>
            ...
            <div className="p-1">
                <p>
                    7.1 This Agreement shall be governed by and construed in accordance with the laws of The Islamic Republic Of Pakistan, without regard to its
                    conflict of laws principles.
                </p>
            </div>

            <h2 className="text-xl font-bold">8. Changes</h2>
